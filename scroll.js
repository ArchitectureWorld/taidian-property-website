(() => {
  ...
  const labels=['LAYER / DAILY SERVICE','LAYER / EXPERIENCE SIGNAL','LAYER / RENEWAL TRACE','LAYER / VALUE PATH','LAYER / PARTNERSHIP'];
  const focuses=[[0,1,2,4,6],[1,3,5,7,8],[0,2,3,6,9],[2,4,5,8,9],[0,1,4,7,9]];
  const focusSets=focuses.map(items=>new Set(items));
  const positions=[[[.13,.24],[.31,.18],[.52,.25],[.74,.18],[.88,.34],[.22,.48],[.43,.44],[.63,.47],[.81,.56],[.56,.72]],[[.18,.19],[.37,.22],[.55,.17],[.78,.25],[.9,.4],[.25,.44],[.46,.49],[.67,.42],[.8,.62],[.55,.76]],[[.12,.31],[.28,.16],[.49,.32],[.7,.2],[.87,.3],[.2,.55],[.4,.47],[.62,.55],[.84,.51],[.54,.75]],[[.1,.23],[.3,.23],[.5,.23],[.7,.23],[.9,.23],[.2,.51],[.4,.51],[.6,.51],[.8,.51],[.5,.76]],[[.15,.2],[.34,.17],[.52,.23],[.72,.17],[.87,.33],[.24,.49],[.44,.43],[.64,.49],[.82,.58],[.56,.7]]];
